# From: https://github.com/jschr/bootstrap-modal/wiki/Ruby-on-Rails----AJAX-Modal-Example
...
$(document).on 'click', '#ajax-modal[data-dismiss=modal], #ajax-modal.modal-scrollable', ->
